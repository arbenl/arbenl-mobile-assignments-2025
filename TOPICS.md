...
16. Healthy Recipes + AI nutrition facts (recipes{id, title, tags[], user_id}) — (Taken by Donart Selmani)
...
32. Book Club (reading list + reviews) (books{id, title, note, user_id}) — (Taken by Edita Delijaj)
